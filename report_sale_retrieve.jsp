			...
			<div id="wrapper">
				...
				<!-- Banner -->
										...
										<table class="table table-bordered">
                                			...
                                			<tbody>
                                    			<tr>
                                         			...
                                         			<td style="text-align:left;  border-right: 1px dotted gray; width:25%;"><b>수강수업&nbsp;&nbsp;</b> ${retrieve.classname}</td>
                                       				<td style="text-align:left;  border-right: 1px dotted gray; width:25%"><b>받은학점&nbsp;&nbsp;</b> ${retrieve.grade}</td>
                               	...
                               	<div>
									...
									<a href="report_sale_delete.do?num=${retrieve.num}&hostID=<%=session.getAttribute("ID")%>">삭제</a></div>
									...
									<br>
										...
										<c:forEach items="${Rlist}" var="rdto">
 									  	<tr>
											...
											<td style="text-align:right;"><a href="report_sale_reply_delete.do?id=${rdto.id}&num=${rdto.num}&hostID=<%=session.getAttribute("ID")%>">삭제</a></td>
										</tr>

										</c:forEach>	
										<tr>
											<td colspan="4" style="background-color:#ffffff;"><jsp:include  page="report_sale_reply_page.jsp?num=${retrieve.num}"  flush="true" /></td>
										</tr>
										</table>
										</form>
								</div>
